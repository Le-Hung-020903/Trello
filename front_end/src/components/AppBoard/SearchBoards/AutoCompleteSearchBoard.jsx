...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    // Dùng createSearchParams của react-router để tạo một cái searchPath chuẩn với q[title] để gọi lên API
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally(() => {
        // khi search xong chuyển thành false
        setLoading(false)
      })
  }
  ...
  return (
    <Autocomplete
      ...
      onInputChange={debouceSearchBoard}
